...
class StudioBrand(unittest.TestCase):
    def test_metadata_and_assets(self):
        for route in ('index.html', 'organization/index.html'):
            ...
            self.assertIn('https://kangdaejong.com/og-studio-20260924.png', html)
            self.assertIn('/favicon.svg?v=studio-20260924', html)
        self.assertTrue((ROOT/'dist/og-studio-20260924.png').read_bytes().startswith(b'\x89PNG'))
