...
export const currentProjects = [
  ...
  { name: '문의노트', mark: '문', category: '비전화 문의 관리', status: '개인 작업실 · 로그인 필요', description: '문의문을 작성하고 업체별 답변과 다음 확인일을 정리합니다. 본인 계정으로 로그인해 사용하는 개인 작업실입니다.', href: 'https://inquiry-note.ssamssae.chatgpt.site', action: '문의노트 열기' },
