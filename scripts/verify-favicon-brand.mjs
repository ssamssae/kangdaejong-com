...
const checks = [
  ["shared layout includes ICO favicon", /<link rel="icon" href="\/favicon\.ico\?v=studio-20260924" sizes="any" \/>/.test(layout)],
  ["shared layout includes SVG favicon", /<link rel="icon" type="image\/svg\+xml" href="\/favicon\.svg\?v=studio-20260924" \/>/.test(layout)],
