...
const checks = [
  ...
  ["organization uses editorial responsibility sections", /class="r-owner-map"/.test(organization) && /class="r-process"/.test(organization) && /class="r-checks"/.test(organization)],
